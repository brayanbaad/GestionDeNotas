...
namespace GestionDeNotas
{
    public partial class FrmDocentes : Form
    {
        ...
        {
            especialidadService = new EspecialidadService(ConfigConnection.connectionString);
            cmbEspecialidad.DataSource = especialidadService.Consultar();
        ...
        private void btnIconRegistrar_Click(object sender, EventArgs e)
        {
            ...
            docente.IdDocente =  txtIdentificacion.Text;
            ...
            docente.Especialidad = cmbEspecialidad.Text;
        ...
        private void dtgDocentes_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmbEspecialidad.Text = dtgDocentes.CurrentRow.Cells[6].Value.ToString();
        ...
        private void btnIconBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (identificacion != "")
            {
                ...
                if (docente != null)
                {
                    ...
                    cmbEspecialidad.Text = docente.Especialidad;
        ...
        private void txtNombreBuscar_TextChanged(object sender, EventArgs e)
        {
            ...
            docenteService = new DocenteService(ConfigConnection.connectionString);
            dtgDocentes.DataSource = docenteService.BuscarContiene(nombre);
        }
        ...
        private void txtIdentificacionBuscar_TextChanged(object sender, EventArgs e)
        {
            ...
            docenteService = new DocenteService(ConfigConnection.connectionString);
            dtgDocentes.DataSource = docenteService.BuscarContiene(identificacion);
        }
